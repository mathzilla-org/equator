...
BUILD_DIR = ./build
BUILD_JS = $(BUILD_DIR)/equator.js
BASIC_JS = $(BUILD_DIR)/equator-basic.js
BUILD_CSS = $(BUILD_DIR)/equator.css
BASIC_CSS = $(BUILD_DIR)/equator-basic.css
BUILD_TEST = $(BUILD_DIR)/equator.test.js
UGLY_JS = $(BUILD_DIR)/equator.min.js
UGLY_BASIC_JS = $(BUILD_DIR)/equator-basic.min.js

# programs and flags
UGLIFY ?= ./node_modules/.bin/uglifyjs
UGLIFY_OPTS ?= --mangle --compress hoist_vars=true --comments /mail.websofter@gmail.com/
