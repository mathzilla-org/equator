suite('latex', function() {
  ...
  suite('\\EquatorMathField', function() {
    var outer, inner1, inner2;
    setup(function() {
      outer = MQ.StaticMath(
        $('<span>\\frac{\\EquatorMathField{x_0 + x_1 + x_2}}{\\EquatorMathField{3}}</span>')
        .appendTo('#mock')[0]
      );
    ...
    test('optional inner field name', function() {
      outer.latex('\\EquatorMathField[mantissa]{}\\cdot\\EquatorMathField[base]{}^{\\EquatorMathField[exp]{}}');
    ...
    test('make inner field static and then editable', function() {
      outer.latex('y=\\EquatorMathField[m]{\\textcolor{blue}{m}}x+\\EquatorMathField[b]{b}');
