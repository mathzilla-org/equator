suite('HTML', function() {
  ...
  test('simple HTML templates', function() {
    ...
    var html = '<span equator-command-id=1>A Symbol</span>';

    assert.equal(html, renderHtml(0, htmlTemplate), 'a symbol');

    htmlTemplate = '<span>&0</span>';
    html = '<span equator-command-id=1 equator-block-id=2>Block:0</span>';
    ...
    ;
    html =
        '<span equator-command-id=1>'
      +   '<span equator-block-id=2>Block:0</span>'
      +   '<span equator-block-id=3>Block:1</span>'
      + '</span>'
    ;
  ...
  test('context-free HTML templates', function() {
    var htmlTemplate = '<br/>';
    var html = '<br equator-command-id=1/>';
    ...
    ;
    html =
        '<span equator-command-id=1></span>'
      + '<span equator-command-id=1/>'
      + '<span equator-command-id=1>'
      +   '<span>'
      +     '<span/>'
      ...
      +   '<span></span>'
      + '</span>'
      + '<span equator-command-id=1 equator-block-id=2>Block:0</span>'
    ;
