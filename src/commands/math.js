...
var MathCommand = P(MathElement, function(_, super_) {
  ...
  // and selection of the Equator tree, these all take in a direction and
  // the cursor
  ...
  */
  ...
  _.html = function() {
    ...
    // - insert the equator-command-id attribute into all top-level tags,
    ...
    //       rendered as HTML
    //     + insert the equator-block-id attribute into the containing tag
    ...
    var cmdId = ' equator-command-id=' + cmd.id;
    ...
    return tokens.join('').replace(/>&(\d+)/g, function($0, $1) {
      return ' equator-block-id=' + blocks[$1].id + '>' + blocks[$1].join('html');
    });
  };
...
API.StaticMath = function(APIClasses) {
  return P(APIClasses.AbstractEquator, function(_, super_) {
