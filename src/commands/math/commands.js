...
else if ('filter' in div_style) { //IE 6, 7, & 8 fallback, see https://github.com/laughinghan/equator/wiki/Transforms
...
// https://github.com/equator/equator/pull/191#discussion_r4327442
...
LatexCmds.EquatorMathField = P(MathCommand, function(_, super_) {
  _.ctrlSeq = '\\EquatorMathField';
  _.htmlTemplate =
...
// From Equator's perspective, it's a Symbol, it can be
