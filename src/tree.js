...
/**
 * Equator virtual-DOM tree-node abstract base class
 */
var Node = P(function(_) {
  ...
  _.toString = function() { return '{{ Equator Node #'+this.id+' }}'; };
  ...
  _.jQize = function(jQ) {
    ...
    function jQadd(el) {
      if (el.getAttribute) {
        var cmdId = el.getAttribute('equator-command-id');
        var blockId = el.getAttribute('equator-block-id');
